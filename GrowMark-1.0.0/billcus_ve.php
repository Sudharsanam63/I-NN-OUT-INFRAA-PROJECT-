...
$sql2 = "SELECT * FROM cart where customer_name='" . $_SESSION["c_username"] . "'";
$result2 = mysqli_query($conn, $sql2);
$row2 = mysqli_fetch_array($result2);

$cart_id=$row2['customerid'];

$sql = "SELECT * FROM bill where customerid='" . $cart_id . "'";
...
<body>
            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light p-lg-0">
                ...
                <div class="navbar-nav">
                    <a href="index.php" class="nav-item nav-link">Home</a>
                        ...
                        <a href="bill_cus.php" class="nav-item nav-link ">Bills</a>
    ...
    <h1 class="fw-bold m-0" style="text-align:center;color:black;">Bill</h1>
    ...
    while($row = mysqli_fetch_assoc($result)) {
       ...
       <tbody>
						    <tr class="alert" role="alert">
						      ...
						      <th><?php echo $row2["cart_name"]; ?></th>
						      <td>₹<?php echo $row["tot"]; ?>/Sq.ft</td>
						      <td>
                              <a href="/GrowMark-1.0.0/Payment/pay.php?id=<?php echo $row["bill_id"]; ?>" class="close text-primary" data-dismiss="alert" aria-label="Close"><button type="button" class="btn btn-primary" style="text-decoration:none;color:#fff;">Pay</button></a>
                              	</td>
						    </tr>
                            </tbody>		   
        <?php
