        ...
        <div class="container">
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <form action="http://localhost:5000/contact_page" method="post">
                        <div class="row g-3">
                            <div class="col-md-6">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" required name="sub" id="subject" placeholder="Subject">
                                    <label for="subject">Subject</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control" required name="mes" placeholder="Leave a message here" id="message" style="height: 200px"></textarea>
                                    <label for="message">Message</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <button class="btn btn-primary rounded-pill py-3 px-5" name="submitDetails" type="submit">Send Message</button>
                            </div>
                        </div>
                    </form>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    ...
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3911.4910028409618!2d77.6846323937684!3d11.371840678717573!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba9693b66fd48f9%3A0xd51410f759c230df!2s23D%2C%20Sengunthar%20Nagar%2C%20Periya%20Semur%2C%20Tamil%20Nadu%20638004!5e0!3m2!1sen!2sin!4v1680257660669!5m2!1sen!2sin"
