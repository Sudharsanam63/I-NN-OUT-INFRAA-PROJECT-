        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg bg-white navbar-light p-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <a href="indexlog.php" class="nav-item nav-link">Home</a>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <a href="Modular.php"><div class="team-item rounded overflow-hidden pb-4 cd">
                        <img class="img-fluid mb-4 cdim" src="img/in1.jpg" alt="">
                        <h5>MODULAR WORKS</h5>
                        <span class="text-primary text-muted"> 2 Works Available </span>
                        
                     </div></a>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item rounded overflow-hidden pb-4 cd">
                        <img class="img-fluid mb-4 cdim" style="width:100%;" src="img/in2.jpg" alt="">
                        <h5>ALUMINIUM WORKS</h5>
                        <span class="text-primary text-muted"> 5 Works Available</span>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item rounded overflow-hidden pb-4 cd">
                        <img class="img-fluid mb-4 cdim" style="width:100%;" src="img/in3.jpg" alt="">
                        <h5>TOUGHENED GLASS</h5>
                        <span class="text-primary text-muted">2 Works Available</span>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <a href="false.php"><div class="team-item rounded overflow-hidden pb-4 cd">
                        <img class="img-fluid mb-4 cdim" style="width:100%;"src="img/in4.jpg" alt="">
                        <h5>FALSE CEILING</h5>
                        <span class="text-primary text-muted">7 Works Available</span>
                    </div></a>
                </div>
                <!-- <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item rounded overflow-hidden pb-4">
                        <img class="img-fluid mb-4" src="img/in5.jpg" alt="">
