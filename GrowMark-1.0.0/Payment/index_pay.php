...
<div class="container">
	<div class="screen">
		<div class="screen__content">
			<form class="signup" action="pay.php" method="post">
				<div class="login__field">
					<i class="login__icon fas fa-user"></i>
					<input name="name" type="text" class="login__input" placeholder="Name" required>
				</div>
                <div class="login__field">
					<i class="login__icon fas fa-user"></i>
					<input name="c_phoneno" type="text" class="login__input" placeholder="Buyer" required>
				</div>
                <div class="login__field">
					<i class="login__icon fas fa-user"></i>
					<input name="amount" type="text" class="login__input" placeholder="amount" value="100" required>
				</div>
                <div class="login__field">
					<i class="login__icon fas fa-user"></i>
                ...
                <div class="login__field">
					<i class="login__icon fas fa-user"></i>
					<input type="password" name="c_password" class="login__input" id="cn_password" placeholder="purpose" value="Mobile Back case" required>
                    <span id="cp"><span>
				</div>
                <button type="submit" name="pay" class="button login__submit">
