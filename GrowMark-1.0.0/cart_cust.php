...
session_start();
$sql = "SELECT * FROM cart where customer_name='" . $_SESSION["c_username"] . "'";
...
<body>
    ...
    <!-- Navbar End -->
    <h1 class="fw-bold m-0" style="text-align:center;color:black;">Cart</h1>
    <?php
			...
			<div class="row">
				<div class="col-md-12">
					<div class="table-wrap">
						<table class="table" style="border:#000;">
    ...
    while($row = mysqli_fetch_assoc($result)) {
       ...
       <tbody style="font-weight:bold;">
						    <tr class="alert" role="alert">
						      ...
						      <td>
						      	<a href="cart_del.php?id=<?php echo $row["cart_id"]; ?>" class="close" data-dismiss="alert" aria-label="Close">
