...
<head>
    ...
    <!-- Favicon -->
    <link href="/GrowMark-1.0.0/img/favicon.ico" rel="icon">
...
<body>
    ...
    <h1 class="fw-bold m-0" style="text-align:center;color:black;">Passed Bills</h1>
    ...
    while($row = mysqli_fetch_assoc($result)) {
       ...
       <tbody>
						    <tr class="alert" role="alert">
						      ...
						      <td>
                              <a href="bill_gene.php?id=<?php echo $row["bill_id"]; ?>" class="close text-primary" data-dismiss="alert" aria-label="Close"><button type="button" class="btn btn-primary" style="text-decoration:none;color:#fff;">Complete</button></a>
                              	</td>
						    </tr>
                            </tbody>		   
        <?php
