          ...
          <div class="card-body p-5">
            ...
            <div class="border-top border-gray-200 pt-4 mt-4">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="text-muted mb-2">GST</div>
                  <strong>33AUKPJ2482K1ZF</strong>
                </div>
            ...
            <div class="border-top border-gray-200 mt-4 py-4">
              <div class="row">
                ...
                <div class="col-md-6 text-md-end">
                  ...
                  <p class="fs-sm">
                  23-B1,sengunthar Nagar,Periyasemur,Erode -638 004
                    <br>
                    <a href="#!" class="text-purple">innoutinfraa@gmail.com
                    </a>
                  </p>
                </div>
              </div>
            ...
            <div class="mt-5">
              <div class="d-flex justify-content-end mt-3">
                ...
                <h5 class="text-success">₹<?php echo $row["tot"]+360; ?></h5>
              </div>
            </div>
          </div>
