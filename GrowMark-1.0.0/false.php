...
$sql = "SELECT * FROM design_db WHERE design_type='falseceling'";
...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s" style="background-color:#8e6a0f;">
        <div class="container text-center py-5">
            <h1 class="display-2 text-white mb-4 animated slideInDown">Falseceling Works</h1>
                ...
                <div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <a href="Modular.html"><div class="team-item rounded overflow-hidden pb-4 mrr" style="background-color:#323c54;">
                        ...
                        <table class="table" style="border: 1px solid white;">
                          ...
                          ';
?>
                        <center><button class="button-29"><a href="cart_create.php?id=<?php echo $row["design_id"]; ?>" style="color:white;">click to order</a></button></center><br>
                     </div></a>
                     </div>
